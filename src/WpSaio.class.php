            ...
            'facebook-messenger' => array(
                ...
                'params' => array(
                    'url' => array(
                        ...
                        'desc' => __('Example: https://m.me/username', 'support-chat'),
                    ),
                ),
            ),
            'whatsapp' => array(
                ...
                'params' => array(
                    'phone' => array(
                        ...
                        'desc' => __('Example: https://wa.me/phoneNumber', 'support-chat'),
                    ),
                ),
            ),
            'snapchat' => array(
                ...
                'params' => array(
                    'username' => array(
                        ...
                        'desc' => __('Example: https://www.snapchat.com/add/username', 'support-chat'),
                    ),
                ),
            ),
            'line' => array(
            ...
            'viber' => array(
                ...
                'params' => array(
                    'account' => array(
                        ...
                        'desc' => __('Example: viber://add?number=+123456789', 'support-chat'),
                    ),
                ),
            ),
            'phone' => array(
                ...
                'params' => array(
                    'phone_number' => array(
                        ...
                        'required' => true,
                        'placeholder' => __('Phone Number', 'support-chat'),
                        'desc' => __('Example: tel:+123456789', 'support-chat'),
                    ),
                ),
            ),
            'email' => array(
                ...
                'params' => array(
                    'email' => array(
                        ...
                        'desc' => __('Example: mailto:support@ninjateam.org', 'support-chat'),
                    ),
                ),
            ),
            'telegram' => array(
                ...
                'params' => array(
                    'username' => array(
                        ...
                        'desc' => __('Example: https://t.me/username', 'support-chat'),
                    ),
                ),
            ),
            'skype' => array(
                ...
                'params' => array(
                    'username' => array(
                        ...
                        'desc' => __('Example: skype:username?call', 'support-chat'),
                    ),
                ),
            ),
            'zalo' => array (
			...
			c1.37,0,2.49,1.12,2.49,2.49C23.53,14.1,22.41,15.22,21.04,15.22z"/></svg>',
                ...
                'params' => array(
                    'username' => array(
                        ...
                        'desc' => __('Example: https://zalo.me/username', 'support-chat'),
                    ),
                ),
            ),
            'kakaotalk' => array (
		...
		l-1.71,1.71l1.85,2.45C22.5,13.76,22.56,13.96,22.53,14.16z"/></svg>',
                ...
                'params' => array(
                    'username' => array(
                        ...
                        'desc' => __('Example: kakaotalk://open/chat/<channel_id>', 'support-chat'),
                    ),
                ),
            ),
            'wechat' => array (
		...
		c-0.12,0.44-0.46,0.79-0.9,0.9V9.08z"/></svg>',
                ...
                'params' => array(
                    'email' => array(
                        ...
                        'desc' => __('Example: weixin://dl/chat?{user_id}', 'support-chat'),
                    ),
                ),
            ),
            'custom-app' => array(
